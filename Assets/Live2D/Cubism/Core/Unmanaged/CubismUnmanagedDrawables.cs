...
namespace Live2D.Cubism.Core.Unmanaged
{
    ...
    public sealed class CubismUnmanagedDrawables
    {
        ...
        internal unsafe CubismUnmanagedDrawables(IntPtr modelPtr)
        {
            ...
            length = CubismCoreDll.GetDrawableCount(modelPtr);
            MultiplyColors =
                new CubismUnmanagedFloatArrayView(CubismCoreDll.GetDrawableMultiplyColors(modelPtr), length * 4);

            length = CubismCoreDll.GetDrawableCount(modelPtr);
            ScreenColors =
                new CubismUnmanagedFloatArrayView(CubismCoreDll.GetDrawableScreenColors(modelPtr), length * 4);

            length = CubismCoreDll.GetDrawableCount(modelPtr);
            ParentPartIndices =
                new CubismUnmanagedIntArrayView(CubismCoreDll.GetDrawableParentPartIndices(modelPtr), length);
            ...
            for (var i = 0; i < length; ++i) Masks[i] = new CubismUnmanagedIntArrayView(_masks[i], length2[i]);
            ...
            for (var i = 0; i < length; ++i) Indices[i] = new CubismUnmanagedUshortArrayView(_indices[i], length2[i]);
        }
        ...
        /// </summary>
        /// >
        public CubismUnmanagedIntArrayView[] Masks { get; }
        ...
        /// </summary>
        /// >
        public CubismUnmanagedFloatArrayView[] VertexPositions { get; }

        /// <summary>
        ///     2D texture coordinate data of each drawables.
        /// </summary>
        /// >
        public CubismUnmanagedFloatArrayView[] VertexUvs { get; }
        ...
        /// </summary>
        /// >
        public CubismUnmanagedUshortArrayView[] Indices { get; }
