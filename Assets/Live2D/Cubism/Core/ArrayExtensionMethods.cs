...
namespace Live2D.Cubism.Core
{
    ...
    public static class ArrayExtensionMethods
    {
        ...
        internal static void Revive(this CubismParameter[] self, CubismUnmanagedModel model)
        {
            ...
            for (var i = 0; i < self.Length; ++i) self[i].Revive(model);
        }
        ...
        internal static void WriteTo(this CubismParameter[] self, CubismUnmanagedModel unmanagedModel)
        {
            ...
            // Push.
            for (var i = 0; i < self.Length; ++i) values[self[i].UnmanagedIndex] = self[i].Value;
        }
        ...
        internal static void ReadFrom(this CubismParameter[] self, CubismUnmanagedModel unmanagedModel)
        {
            ...
            // Pull.
            for (var i = 0; i < self.Length; ++i) self[i].Value = values[self[i].UnmanagedIndex];
        }
        ...
        internal static void WriteTo(this CubismPart[] self, CubismUnmanagedModel unmanagedModel)
        {
            ...
            // Push.
            for (var i = 0; i < self.Length; ++i) opacities[self[i].UnmanagedIndex] = self[i].Opacity;
        }
        ...
        internal static unsafe void ReadFrom(this CubismDynamicDrawableData[] self, CubismUnmanagedModel unmanagedModel)
        {
            ...
            for (var i = 0; i < self.Length; ++i)
            {
                ...
                if (!data.AreVertexPositionsDirty) continue;
                ...
                if (!data.IsBlendColorDirty) continue;

                var rgbaIndex = i * 4;
                data.MultiplyColor = new Color(multiplyColors[rgbaIndex], multiplyColors[rgbaIndex + 1],
                    multiplyColors[rgbaIndex + 2], multiplyColors[rgbaIndex + 3]);
                data.ScreenColor = new Color(screenColors[rgbaIndex], screenColors[rgbaIndex + 1],
                    screenColors[rgbaIndex + 2], screenColors[rgbaIndex + 3]);
            }
