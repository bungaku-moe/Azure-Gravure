...
namespace Live2D.Cubism.Core
{
    ...
    public sealed class CubismDrawable : MonoBehaviour
    {
        ...
        public string Id =>
            // Pull data.
            UnmanagedDrawables.Ids[UnmanagedIndex];
        ...
        public int TextureIndex =>
            // Pull data.
            UnmanagedDrawables.TextureIndices[UnmanagedIndex];
        ...
        public int ParentPartIndex =>
            // Pull data.
            UnmanagedDrawables.ParentPartIndices[UnmanagedIndex];
        ...
        public CubismDrawable[] Masks
        {
            get
            {
                ...
                {
                    if (drawables[j].UnmanagedIndex != indices[UnmanagedIndex][i]) continue;
        ...
        public int[] Indices
        {
            get
            {
                ...
                for (var i = 0; i < buffer.Length; ++i) buffer[i] = indices[UnmanagedIndex][i];
