...
namespace Live2D.Cubism.Plugins.Editor
{
    ...
    public class CubismiOSPluginProcessor : IPreprocessBuildWithReport
    {
        ...
        private class CubismiOSPlugin
        {
            ...
            public static CubismiOSPlugin DebugIphoneos => new("Debug-iphoneos");

            public static CubismiOSPlugin DebugIphoneSimulator => new("Debug-iphonesimulator");

            public static CubismiOSPlugin ReleaseIphoneos => new("Release-iphoneos");

            public static CubismiOSPlugin ReleaseIphoneSimulator => new("Release-iphonesimulator");
        }
    }
}
