...
namespace Live2D.Cubism.Framework.Utils
{
    public class CubismMath : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param name="dividend">
        ///     <see cref="Mathf.Infinity" />, <see cref="Mathf.NegativeInfinity" /> and
        ///     <see cref="float.NaN" /> are not allowed.
        /// </param>
        ...
        public static float ModF(float dividend, float divisor)
        {
            ...
            {
                Debug.LogWarning(
                    $"Invalid dividend or divisor. divided: {dividend}, divisor: {divisor} Mod() returns 'NaN'.");
                return float.NaN;
            }
