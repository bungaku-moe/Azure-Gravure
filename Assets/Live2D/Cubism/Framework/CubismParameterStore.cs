...
namespace Live2D.Cubism.Framework
{
    ...
    public class CubismParameterStore : MonoBehaviour, ICubismUpdatable
    {
        ...
        public void Refresh()
        {
            if (DestinationParameters == null) DestinationParameters = this.FindCubismModel().Parameters;

            if (DestinationParts == null) DestinationParts = this.FindCubismModel().Parts;
        ...
        public void SaveParameters()
        {
            ...
            // save parts opacity
            if (DestinationParts != null && _partOpacities == null) _partOpacities = new float[DestinationParts.Length];
