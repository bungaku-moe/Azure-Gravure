...
namespace Live2D.Cubism.Framework.Motion
{
    ...
    public class CubismMotionController : MonoBehaviour
    {
        ...
        private void OnAnimationEnd(int layerIndex, float instanceId)
        {
            ...
            if (AnimationEndHandler != null) AnimationEndHandler(instanceId);
        }
        ...
        public void PlayAnimation(AnimationClip clip, int layerIndex = 0,
            int priority = CubismMotionPriority.PriorityNormal, bool isLoop = true, float speed = 1.0f)
        {
            // Fail silently...
            ...
            // Play Playable Graph
            if (!_playableGrap.IsPlaying()) _playableGrap.Play();
        }
        ...
        {
            for (var i = 0; i < LayerCount; ++i) _motionLayers[i].StopAnimationClip();
        }
        ...
        private void OnEnable()
        {
            ...
            if (graph.IsValid()) graph.GetOutput(0).SetWeight(0);
        ...
        private void OnDisable()
        {
            ...
            if (_playableGrap.IsValid()) _playableGrap.Destroy();
        }
