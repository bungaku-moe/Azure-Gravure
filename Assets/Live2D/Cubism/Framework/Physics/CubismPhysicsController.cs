...
namespace Live2D.Cubism.Framework.Physics
{
    ...
    {
        [SerializeField] private CubismPhysicsRig _rig;
        ...
        public void OnLateUpdate()
        {
            ...
            if (CubismPhysics.UseFixedDeltaTime) deltaTime = Time.fixedDeltaTime;
        ...
        public void Stabilization()
        {
            ...
            if (maskController) maskController.OnLateUpdate();
        }
        ...
        public void SetPhysicsSubRigOutputAngleScaleRatio(CubismPhysicsSubRig subRig, float ratio)
        {
            ...
            for (var i = 0; i < subRig.Output.Length; i++)
            {
        ...
        public void Awake()
        {
            ...
            for (var i = 0; i < Rig.SubRigs.Length; ++i) Rig.SubRigs[i].Rig = Rig;
