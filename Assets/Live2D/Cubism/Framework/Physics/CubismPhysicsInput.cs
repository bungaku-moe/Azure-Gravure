...
namespace Live2D.Cubism.Framework.Physics
{
    ...
    public struct CubismPhysicsInput
    {
        ...
        /// </summary>
        [SerializeField] public Vector2 ScaleOfTranslation;
        ...
        /// </summary>
        [NonSerialized] public CubismParameter Source;

        /// <summary>
        ///     <see cref="Source" /> index.
        /// </summary>
        [NonSerialized] public int SourceIndex;

        /// <summary>
        ///     Function of getting normalized parameter value.
        /// </summary>
        [NonSerialized] public NormalizedParameterValueGetter GetNormalizedParameterValue;
    }
}
