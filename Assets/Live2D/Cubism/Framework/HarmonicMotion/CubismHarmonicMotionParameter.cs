...
namespace Live2D.Cubism.Framework.HarmonicMotion
{
    ...
    public sealed class CubismHarmonicMotionParameter : MonoBehaviour
    {
        ...
        ///     Motion direction.
        /// </summary>
        [SerializeField] public CubismHarmonicMotionDirection Direction;
        ...
        /// </remarks>
        [SerializeField] [Range(0f, 1f)] public float NormalizedOrigin = 0.5f;
        ...
        ///     The actual origin used for evaluating the motion depends limits of the <see cref="CubismParameter" />.
        /// </remarks>
        [SerializeField] [Range(0f, 1f)] public float NormalizedRange = 0.5f;

        /// <summary>
        ///     Duration of one motion cycle in seconds.
        /// </summary>
        [SerializeField] [Range(0.01f, 10f)] public float Duration = 3f;
