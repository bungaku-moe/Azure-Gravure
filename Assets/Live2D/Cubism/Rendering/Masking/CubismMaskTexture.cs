...
namespace Live2D.Cubism.Rendering.Masking
{
    ...
    public sealed class CubismMaskTexture : ScriptableObject, ICubismMaskCommandSource
    {
        ...
        /// </summary>
        [SerializeField] [HideInInspector] private int _size = 1024;


        /// <summary>
        ///     <see cref="Subdivisions" /> backing field.
        /// </summary>
        [SerializeField] [HideInInspector] private int _subdivisions = 3;

        /// <summary>
        ///     <see cref="RenderTextureCount" /> backing field.
        /// </summary>
        [SerializeField] [HideInInspector] private int _renderTextureCount;
        ...
        public static CubismMaskTexture GlobalMaskTexture =>
            Resources.Load<CubismMaskTexture>("Live2D/Cubism/GlobalMaskTexture");
        ...
        {
            get => _renderTextureCount;
            set
            {
                if (value == _renderTextureCount) return;
        ...
        private RenderTexture RenderTexture
        {
            get
            {
                if (_renderTexture == null) RefreshRenderTexture();
        ...
        public RenderTexture[] RenderTextures
        {
            get
            {
                if (_renderTextures == null) RefreshRenderTextures();
        ...
        /// </summary>
        private bool ContainsSources => CommandSources != null && CommandSources.Count > 0;
        ...
        private void TryRevive()
        {
            ...
            if (IsRevived || isUseRenderTextures) return;
        ...
        /// </summary>
        public int CountOfCommandBuffers => RenderTextureCount;
        ...
        public void AddSource(ICubismMaskTextureCommandSource source)
        {
            ...
            if (CommandSources == null) CommandSources = new List<ICubismMaskTextureCommandSource>();

            if (CommandSources.FindIndex(i => i == source) != -1) return;
