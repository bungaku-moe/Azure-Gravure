...
namespace Live2D.Cubism.Editor.Inspectors
{
    ...
    internal sealed class CubismPartsInspectorInspector : UnityEditor.Editor
    {
        ...
        /// </summary>
        private bool IsInitialized => Parts != null;
        ...
        private void Initialize()
        {
            ...
            for (var i = 0; i < Parts.Length; i++)
            {
                ...
                else
                {
                    ...
                    Array.Resize(ref parent.children, parent.children.Length + 1);
        ...
        private static class Internal
        {
            public static void OnInspectorGUI(ref bool didPartsChange, InspectorViewData[] src, int indent = 0)
            {
                for (var i = 0; i < src.Length; i++)
                {
                    ...
                    if (src[i].foldout) OnInspectorGUI(ref didPartsChange, src[i].children, indent + 1);
                }
            }
