...
namespace Kiraio.Azure.Utils
{
    ...
    public static class WebRequestHelper
    {
        ...
        public static string GetTextData(string url)
        {
            try
            {
        ...
        /// <param name="url"></param>
        /// <returns>Text data.</returns>
        public static async UniTask<string> GetTextDataAsync(string url)
        {
            try
            {
                using UnityWebRequest uwr = UnityWebRequest.Get(url);
        ...
        /// <param name="url"></param>
        /// <returns>Array of byte.</returns>
        public static async UniTask<byte[]> GetBinaryDataAsync(string url)
        {
            try
            {
                using UnityWebRequest uwr = UnityWebRequest.Get(url);
